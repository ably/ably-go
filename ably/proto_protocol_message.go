...
// protocolPublishResult matches the wire format for publish results in ACK messages (TR4s, PBR2a).
...
type protocolMessage struct {
	...
	Res               []*protocolPublishResult `json:"res,omitempty" codec:"res,omitempty"` // TR4s: publish results in ACK
}
