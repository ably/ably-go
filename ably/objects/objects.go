...
// Plugin is used to add LiveObject functionlity to a realtime client:
//
//	client, err := ably.NewRealtime(
//		ably.WithKey(...),
//		ably.WithObjectsPlugin(myObjectsPlugin),
//	)
//
...
type Operation struct {
	...
	InitialValue         []byte          `json:"initialValue,omitempty" codec:"initialValue,omitempty"`
	InitialValueEncoding *string         `json:"initialValueEncoding,omitempty" codec:"initialValueEncoding,omitempty"`
}
