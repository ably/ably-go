...
#### Increase MaxMessageSize/read limit for realtime connection
...
- This value defaults to 65536(64kb) for normal account, you can increase the limit by contacting ably support.
